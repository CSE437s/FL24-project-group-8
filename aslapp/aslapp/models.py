...
class PhrasePredictor:
    ...
    def extract_landmarks_from_video(self, video_path):
        ...
        # Get the video's frame rate to calculate the interval for 20 frames per second
        video_fps = cap.get(cv2.CAP_PROP_FPS)
        frame_interval = int(video_fps // 20)  # Interval for extracting 20 fps
        ...
        while cap.isOpened() and len(frame_landmarks) < self.num_frames:
            ...
            # Process frame only if it's at the correct interval
            ...
            frame_count += 1  # Increment frame count for interval checking
